...
import {AMMState, NegativeAMMMath} from "./NegativeAMMMath.sol";
import {BaseAMM} from "./BaseAMM.sol";

contract NegativeAMM is BaseAMM {
    using NegativeAMMMath for AMMState;
    ...
    function _calcImpliedRate() internal view override returns (int256) {
        return NegativeAMMMath.calcImpliedRate(_storage.totalFloatAmount, _storage.normFixedAmount);
    }
}
